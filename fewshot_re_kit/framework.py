...
class FewShotREFramework:
    ...
    def train(self,
        ...
        if bert_optim:
            ...
            scheduler = get_linear_schedule_with_warmup(optimizer, warmup_steps=warmup_step, t_total=train_iter)
        else:
        ...
        for it in range(start_iter, start_iter + train_iter):
            ...
            logits, pred = model.forwardtrain(support, query, B, N_for_train, K, Q * N_for_train)
    ...
    def eval(self,
        ...
        with torch.no_grad():
            for it in range(eval_iter):
                ...
                logits, pred, support, query, protoB = model.forwardeval(support, query, B, N, K, Q * N )
                new_samples = model.pseudolabeling(query, pred, logits, B, N, K, 15)
                psupport = torch.cat([support, new_samples], 2)


                logits, pred = model.foradapt(psupport, query, protoB, B, N, K + 15, Q * N)
